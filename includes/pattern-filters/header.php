 ...
 * @return false|string
 */
function real_estate_theme_pattern_header_default( $content ) {
	ob_start();
	/*
	<?php esc_attr_e('Skip to main content','real-estate-listings'); ?>
	<?php esc_attr_e('Real','real-estate-listings'); ?>
	<?php esc_attr_e('estate','real-estate-listings'); ?>
	<?php esc_attr_e('','real-estate-listings'); ?>
	<?php esc_attr_e('','real-estate-listings'); ?>
	...
	*/
    ...
    [bs_skip_links text1='<?php esc_attr_e('Skip to main content','real-estate-listings'); ?>'  hash1='main'  text2=''  hash2=''  text3=''  hash3=''  text_color=''  text_justify='false'  text_align=''  text_align_md=''  text_align_lg=''  mt=''  mr=''  mb=''  ml=''  mt_md=''  mr_md=''  mb_md=''  ml_md=''  mt_lg=''  mr_lg=''  mb_lg=''  ml_lg=''  pt=''  pr=''  pb=''  pl=''  pt_md=''  pr_md=''  pb_md=''  pl_md=''  pt_lg=''  pr_lg=''  pb_lg=''  pl_lg=''  border=''  rounded=''  rounded_size=''  shadow=''  css_class='' ]
...
add_filter( 'blockstrap_pattern_header_default', 'real_estate_theme_pattern_header_default', 15 );
 ...
 */
function real_estate_theme_pattern_header_transparent( $content ) {
	...
	return str_replace(
		...
		real_estate_theme_pattern_header_default( $content )
	);
}
add_filter( 'real_estate_pattern_header_transparent', 'real_estate_theme_pattern_header_transparent', 15 );
